<p align="center">
  <h1 align="center"><br><ins>zjushine-ARXIV-DAILY</ins><br>Automatically Update CV Papers Daily using Github Actions</h1>
...
This repository hosts the source code for zjushine-arxiv-daily, an useful sripts to fetch arxiv paper daily. 
...
1. Fork this [repo](https://github.com/Vincentqyw/zjushine-arxiv-daily)
2. Edit configs:
    - Change `GITHUB_USER_NAME` and `GITHUB_USER_EMAIL` in [zjushine-arxiv-daily.yml](../.github/workflows/zjushine-arxiv-daily.yml) and [update_paper_links.yml](../.github/workflows/update_paper_links.yml)
...
4. Setting Gitpages (optional)
    ...
    - Now you can open gitpage: https://your_github_usrname.github.io/zjushine-arxiv-daily
